...
module.exports = {
  ...
  tagline: 'Passionate Automation Test Engineer @ Kongsberg Digital',
  url: 'https://autoinfra.github.io',
  baseUrl: '/',
  onBrokenLinks: 'ignore',
  onBrokenMarkdownLinks: 'warn',
  favicon: 'img/AutoInfra.png',
  organizationName: 'autoinfra', // Usually your GitHub org/user name.
  projectName: 'autoinfra.github.io', // Usually your repo name. 
  trailingSlash: false,
  //ok
  themeConfig: {
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/autoinfra',
          label: 'GitHub',
          position: 'right',
        },
      ],
